...
Based on Material Design Icons 6.7.96. See a [web demo](https://ziofat.github.io/material_design_icons_flutter/) build with this package.
...
```yaml
  material_design_icons_flutter: 5.0.6796
```
